...
import { LucideCircleCheckBig, Sparkle ,X } from 'lucide-react'
                ...
                <div className={bannerStyles.grid}>
                    <div className={bannerStyles.leftContent}>
                        ...
                        <p className={bannerStyles.description}>
                            Create beautiful and  responsive web applications with our
                    ...
                    <div className={bannerStyles.imageContainer} >
                        <img src={Bannerimage} alt='bannerImg' className={bannerStyles.image} />
                    </div>
                </div>
            </div>
